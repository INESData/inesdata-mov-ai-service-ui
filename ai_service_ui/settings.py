...
class Settings(BaseSettings):
    """Settings."""
    stop_information_path:str = "./ai_service_ui/components/stop_information.json"
    line_information_path:str = "./ai_service_ui/components/line_information.json"
    ...
    lines_per_stop_path:str = "./ai_service_ui/components/lines_per_stop.json"
    stop_per_lines:str = "./ai_service_ui/components/stop_per_line.json"

    post_api_url: str =  "https://conn-gmv-mobility.ds.inesdata-project.eu/public/{stop_id}/arrives/{line_id}"
    api_key: str = "e54d4431-5dab-474e-b71a-0db1fcb9e659"
    get_api_url: str = "https://conn-gmv-mobility.ds.inesdata-project.eu/public/"
